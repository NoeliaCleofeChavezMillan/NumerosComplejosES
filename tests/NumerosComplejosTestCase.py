...
class AsignaturaTestCase ( unittest.TestCase ) :
    ...
    def test_verificar_almacenamiento_agregar_estudiante(self):
        self.controladorEstudiante.agregar_estudiante(apellidoPaterno="Mauricio", apellidoMaterno="Rivera",
                                                      nombres="Richard",
                                                      elegible=True)

        self.session = Session()
        estudiante = self.session.query(Estudiante).filter(Estudiante.apellidoPaterno == "Mauricio",
                                                           Estudiante.apellidoMaterno == "Rivera",
                                                           Estudiante.nombres == "Richard",
                                                           Estudiante.elegible == True).first()
